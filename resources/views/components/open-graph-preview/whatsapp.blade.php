{{-- WhatsApp commonly uses a wide image above the title and description. --}}
@props(['metaData', 'urlHost'])

<div
    class="mx-auto w-full max-w-md min-w-0 rounded-2xl bg-[#efeae2] p-3 shadow-sm dark:bg-[#202c33]"
    data-open-graph-platform="whatsapp"
>
    <div class="flex justify-center">
        <article class="w-full max-w-sm overflow-hidden rounded-lg rounded-br-sm border border-black/5 bg-white shadow-sm dark:border-white/10 dark:bg-gray-900">
