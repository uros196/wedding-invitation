...
const SAMPLE_TIMELINES: WeddingTimelineItem[] = [
    ...
    },
    {
        ...
        map_url: 'https://maps.google.com/?q=Hram+Pokrova+Presvete+Bogorodice+Valjevo',
        icon: 'Church',
    },
    {
        title: 'Svečani ručak',
...
export default function Welcome() {
    return (
        <>
            ...
            <div className="flex min-h-screen w-full flex-col items-center" style={{ backgroundColor: palette.background }}>
                <div className="mx-auto w-full max-w-lg">
                    ...
                    <RSVPForm group={SAMPLE_GROUP} rsvpDeadline="01. septembra 2026" />

                    {/* Footer */}
                    <div className="relative z-20 px-6 py-10 text-center" style={{ backgroundColor: palette.background }}>
                        <p className="text-3xl font-light" style={{ color: palette.celestial, fontFamily: fonts.script }}>
                            Jelena &amp; Uroš
                        </p>
                    </div>
                </div>
