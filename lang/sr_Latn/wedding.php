...
return [
    ...
    'memory_wall' => [
        ...
        'upload' => [
            ...
            'description' => 'Pošaljite fotografije i snimke sa proslave. Svaki fajl može imati do 1 GB.',
            'dropzone' => 'Prevucite fotografije ili snimke ovde',
            'browse' => 'Izaberite fajlove',
            'dropzone_hint' => 'JPG, PNG, HEIC, MP4, MOV i drugi podržani formati',
            'video_label' => 'Snimak',
            'selected' => 'izabrano',
            'upload_action' => 'Pošaljite fajlove',
            'uploading' => 'Slanje je u toku',
            'queued' => 'Spremno za slanje',
            'completed' => 'Poslato',
            'failed' => 'Slanje nije uspelo',
            'retry' => 'Pokušajte ponovo',
            'cancel' => 'Otkaži',
            'remove' => 'Ukloni',
            'max_files' => 'Odjednom možete izabrati najviše :count fajlova.',
        ...
        'download' => [
            ...
            'selected' => 'Preuzmi izabrane uspomene',
            ...
            'delete_confirmation' => 'Obrisati ovu generisanu arhivu?',
            'cancel_description' => 'Priprema će biti prekinuta i njeni privremeni podaci će biti uklonjeni.',
            'delete_description' => 'Generisana arhiva će biti uklonjena. Vaše poslate uspomene neće biti obrisane.',
            'cancelling' => 'Prekidanje pripreme arhive…',
            'failed' => 'Arhiva nije mogla da bude pripremljena.',
            'no_files' => 'Nema završenih fajlova sa zida uspomena za preuzimanje.',
            'status' => [
                'queued' => 'Na čekanju',
        ...
        'validation' => [
            'file_size' => 'Veličina fajla mora biti između 1 bajta i 1 GB.',
